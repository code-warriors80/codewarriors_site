    ...
    <div className='relative bg-[#1218200D] py-1'>
        ...
        <div className='xl:w-[75%]  lg:w-[100%] md:w-[90%] mx-auto py-16 px-5 sm:px-16 md:px-0'>
            ...
            <div className="carousel carousel-center px-0 p-4 space-x-4 lg:space-x-10 rounded-box w-full mt-20  ">
                  <div className="carousel-item border-2 group hover:border-[#92519c] ease-in-out duration-300 rounded-xl px-5 lg:p-10 py-8 lg:py-16 w-[85%] sm:w-[90%] md:w-[40%] lg:w-[25.20%]">
                       <div>
                                  ...
                                  <ul className='my-10 space-y-3'>
                                          <li className='font-sora text-[15px] lg:text-base text-[#121820] flex items-center gap-3'>
                                            <div className='bg-[#92519c] w-[7px] h-[7px] lg:w-[9px] lg:h-[9px] rounded-full'></div> Accelerate innovation.
                                          </li>
                                          <li className='font-sora text-[15px] lg:text-base text-[#121820] flex items-center gap-3'>
                                            <div className='bg-[#92519c] w-[7px] h-[7px] lg:w-[9px] lg:h-[9px] rounded-full'></div> With world-class tech teams.
                                          </li>
                                          <li className='font-sora text-[15px] lg:text-base text-[#121820] flex items-center gap-3'>
                                            <div className='bg-[#92519c] w-[7px] h-[7px] lg:w-[9px] lg:h-[9px] rounded-full'></div> Our all service offerings to enhance
                                          </li>
                                          <li className='font-sora text-[15px] lg:text-base text-[#121820] flex items-center gap-3'>
                                            <div className='bg-[#92519c] w-[7px] h-[7px] lg:w-[9px] lg:h-[9px] rounded-full'></div>Simply drag, drop and customize
                                          </li>
                                  </ul>

                                 <Link className='font-syne text-[16px] flex items-center gap-3 text-[#121820] w-fit ' href='/'>Learn More <div className='bg-[#12182033] group-hover:bg-[#92519c] p-3 rounded-full relative ease-in-out duration-300 '><BsArrowRight size={15} color='white' className='ease-in-out duration-300'/></div></Link>
                          </div>
                  </div>
                  ...
                  <div className="carousel-item border-2 group hover:border-[#92519c] ease-in-out duration-300 rounded-xl px-5 lg:p-10 py-8 lg:py-16 sm:w-[90%]  w-[85%] md:w-[40%] lg:w-[25.20%]">
                          <div>
