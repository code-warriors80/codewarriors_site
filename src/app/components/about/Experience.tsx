        ...
        <div className='xl:w-[75%]  lg:w-[100%] md:w-[90%] mx-auto px-10 lg:px-0'>
                <div className='lg:flex items-center justify-between space-y-10 lg:space-y-0'>
                    ...
                    <div className='lg:grid lg:grid-cols-2 gap-10 w-full space-y-7 lg:space-y-0'>
                        ...
                        <div>
                            <h6 className='text-[16px] font-syne mb-5'><span className='text-[#92519c] '>16+</span>&nbsp; Years Client Engagement</h6>
                            <div className='mx-auto flex gap-2 '>
                                            <div className='w-[30px] h-[2px] bg-[#92519c]  rounded-full'></div>
                                            <div className='w-full h-[2px] bg-zinc-200 rounded-full'></div>
                            </div>
                        ...
                        <div>
                            <h6 className='text-[16px] font-syne mb-5'><span className='text-[#92519c] '>16+</span>&nbsp; App Development</h6>
                            <div className='mx-auto flex gap-2 '>
                                            <div className='w-[30px] h-[2px] bg-[#92519c]  rounded-full'></div>
                                            <div className='w-full h-[2px] bg-zinc-200 rounded-full'></div>
                            </div>
                        ...
                        <div>
                            <h6 className='text-[16px] font-syne mb-5'><span className='text-[#92519c] '>16+</span>&nbsp; Web Development</h6>
                            <div className='mx-auto flex gap-2 '>
                                            <div className='w-[30px] h-[2px] bg-[#92519c]  rounded-full'></div>
                                            <div className='w-full h-[2px] bg-zinc-200 rounded-full'></div>
                            </div>
