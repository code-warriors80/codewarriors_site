  ...
  return (
    <div className='w-full relative  bg-[#121820]'>
      ...
      <div className="mx-auto max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between mt-15">
            <div className="mb-6 md:mb-0">
                <a href="/" className="flex items-center">
                    {/* <img src="https://flowbite.com/docs/images/logo.svg" className="h-8 me-3" alt="FlowBite Logo" /> */}
                    <span className="self-center text-2xl font-semibold whitespace-nowrap font-syne text-white">Code Warriors</span>
                </a>
            </div>
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    <h2 className="mb-2 text-sm font-syne font-semibold uppercase text-white">Follow us</h2>
                    <ul className="text-white mb-4 font-syne font-medium">
                        <li className="">
                        ...
                        <li>
                            <a href="/" className="hover:underline">Twiter</a>
                        </li>
                    </ul>
                </div>
                <div>
                    <h2 className="mb-6 text-sm font-semibold font-syne text-gray-900 uppercase dark:text-white">Legal</h2>
                    <ul className="text-white mb-4 font-syne font-medium">
                        <li className="">
