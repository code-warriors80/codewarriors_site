  ...
  return (
    <div className='w-full relative  bg-[rgb(18,24,32)]'>
      <div className="mx-auto p-4 py-6 lg:py-8">
        <img src='https://itsulu-react.netlify.app/_next/static/media/deco-2.8cba2eb2.svg' className='w-[200px] hidden lg:block left-40 absolute '/>
        <div className="xl:w-[75%]  lg:w-[100%] md:w-[90%] mx-auto py-16 px-5 sm:px-16 md:px-0">
            <div className="mx-auto px-6 lg:px-8">
                ...
                <div className='py-10 mx-auto w-fit'>
                    <a href="/contact" className="text-[16px] px-[60px] py-5 rounded-full font-sora border-2 border-[#92519c] font text-white"><span>Talk To Our Saas Experts</span></a>
                </div>
